...
(function ($, undefined) {
    ...
    $.widget("ech.multiselect", {
        ...
        _refreshEvent: function () {
            this.menu.find('input[type="checkbox"], input[type="radio"]').click(function () {
                this;
            });
        },
      ...
      .delegate('label', 'click.multiselect', function (e) {
          var target = $(this).children('input')[0];
          e.preventDefault();
          ...
          if (this.disabled || self._trigger('click', e, { value: val, text: target.title, checked: checked }) === false) {
              e.preventDefault();
              return;
          }
